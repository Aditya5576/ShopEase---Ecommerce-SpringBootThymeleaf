package com.adityapatil.ecommerce.dto;
...
public class Product {
	...
	private int id;
	@Size(min = 1, max = 100, message = "* Enter between 3~15 charecters")
	private String name;
	...
	private int stock;
	@Size(min = 5, max = 1000, message = "* Enter between 15~100 charecters")
